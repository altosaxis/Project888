...
.field private mObservers:Landroid/arch/̗/̙/̖;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/arch/\u0317/\u0319/\u0316<",
...
.method public constructor <init>()V
    ...
    .line 64
    new-instance v0, Landroid/arch/̗/̙/̖;

    invoke-direct {v0}, Landroid/arch/̗/̙/̖;-><init>()V

    iput-object v0, p0, Landroid/arch/lifecycle/LiveData;->mObservers:Landroid/arch/̗/̙/̖;
    ...
    .line 78
    new-instance v0, Landroid/arch/lifecycle/̗̗̙;

    invoke-direct {v0, p0}, Landroid/arch/lifecycle/̗̗̙;-><init>(Landroid/arch/lifecycle/LiveData;)V
...
.method static synthetic access$400(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/̗̙̗;)V
    .locals 0

    .line 59
    invoke-direct {p0, p1}, Landroid/arch/lifecycle/LiveData;->dispatchingValue(Landroid/arch/lifecycle/̗̙̗;)V
...
.method private static assertMainThread(Ljava/lang/String;)V
    ...
    .line 434
    invoke-static {}, Landroid/arch/̗/̗/̗;->̗()Landroid/arch/̗/̗/̗;

    move-result-object v0

    invoke-virtual {v0}, Landroid/arch/̗/̗/̗;->̗̗()Z
...
.method private considerNotify(Landroid/arch/lifecycle/̗̙̗;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/arch/lifecycle/LiveData<",
            "TT;>.android/arch/lifecycle/\u0317\u0319\u0317;)V"
        }
    .end annotation

    .line 92
    iget-boolean v0, p1, Landroid/arch/lifecycle/̗̙̗;->̙̖̙̙:Z
    ...
    .line 100
    :cond_0
    invoke-virtual {p1}, Landroid/arch/lifecycle/̗̙̗;->̗̖̗()Z
    ...
    .line 101
    invoke-virtual {p1, v0}, Landroid/arch/lifecycle/̗̙̗;->̗(Z)V

    return-void

    .line 104
    :cond_1
    iget v0, p1, Landroid/arch/lifecycle/̗̙̗;->̙̖̙̗:I
    ...
    .line 107
    :cond_2
    iput v1, p1, Landroid/arch/lifecycle/̗̙̗;->̙̖̙̗:I

    .line 109
    iget-object p1, p1, Landroid/arch/lifecycle/̗̙̗;->̗̗̗̖:Landroid/arch/lifecycle/̖̖̗;

    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->mData:Ljava/lang/Object;

    invoke-interface {p1, v0}, Landroid/arch/lifecycle/̖̖̗;->onChanged(Ljava/lang/Object;)V

    return-void
.end method

.method private dispatchingValue(Landroid/arch/lifecycle/̗̙̗;)V
    .locals 3
    .param p1    # Landroid/arch/lifecycle/̗̙̗;
    ...
    .line 121
    invoke-direct {p0, p1}, Landroid/arch/lifecycle/LiveData;->considerNotify(Landroid/arch/lifecycle/̗̙̗;)V
    ...
    .line 124
    :cond_2
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->mObservers:Landroid/arch/̗/̙/̖;

    .line 125
    invoke-virtual {v1}, Landroid/arch/̗/̙/̖;->̗̖()Landroid/arch/̗/̙/̖̗;
    ...
    check-cast v2, Landroid/arch/lifecycle/̗̙̗;

    invoke-direct {p0, v2}, Landroid/arch/lifecycle/LiveData;->considerNotify(Landroid/arch/lifecycle/̗̙̗;)V
...
.method public hasObservers()Z
    ...
    .line 336
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->mObservers:Landroid/arch/̗/̙/̖;

    invoke-virtual {v0}, Landroid/arch/̗/̙/̖;->size()I
...
.method public observe(Landroid/arch/lifecycle/̙̙;Landroid/arch/lifecycle/̖̖̗;)V
    .locals 2
    .param p1    # Landroid/arch/lifecycle/̙̙;
        .annotation build Landroid/support/annotation/̗̙̗̙;
        .end annotation
    .end param
    .param p2    # Landroid/arch/lifecycle/̖̖̗;
        .annotation build Landroid/support/annotation/̗̙̗̙;
        .end annotation
    .end param
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;-><init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/̙̙;Landroid/arch/lifecycle/̖̖̗;)V

    .line 171
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->mObservers:Landroid/arch/̗/̙/̖;

    invoke-virtual {v1, p2, v0}, Landroid/arch/̗/̙/̖;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Landroid/arch/lifecycle/̗̙̗;

    if-eqz p2, :cond_2

    .line 172
    invoke-virtual {p2, p1}, Landroid/arch/lifecycle/̗̙̗;->̖̖(Landroid/arch/lifecycle/̙̙;)Z
    ...
    invoke-virtual {p1, v0}, Landroid/arch/lifecycle/Lifecycle;->̗(Landroid/arch/lifecycle/̙̗;)V

    return-void
.end method

.method public observeForever(Landroid/arch/lifecycle/̖̖̗;)V
    .locals 2
    .param p1    # Landroid/arch/lifecycle/̖̖̗;
        .annotation build Landroid/support/annotation/̗̙̗̙;
        .end annotation
    .end param
    .annotation build Landroid/support/annotation/̗̙̙̙;
    ...
    .line 198
    new-instance v0, Landroid/arch/lifecycle/̗̙̖;

    invoke-direct {v0, p0, p1}, Landroid/arch/lifecycle/̗̙̖;-><init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/̖̖̗;)V

    .line 199
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData;->mObservers:Landroid/arch/̗/̙/̖;

    invoke-virtual {v1, p1, v0}, Landroid/arch/̗/̙/̖;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/arch/lifecycle/̗̙̗;
    ...
    .line 207
    invoke-virtual {v0, p1}, Landroid/arch/lifecycle/̗̙̖;->̗(Z)V
...
.method protected postValue(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0}, Landroid/arch/̗/̗/̗;->̖(Ljava/lang/Runnable;)V
...
.method public removeObserver(Landroid/arch/lifecycle/̖̖̗;)V
    .locals 1
    .param p1    # Landroid/arch/lifecycle/̖̖̗;
        .annotation build Landroid/support/annotation/̗̙̗̙;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Landroid/arch/̗/̙/̖;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 222
    :cond_0
    invoke-virtual {p1}, Landroid/arch/lifecycle/̗̙̗;->̗̙̗()V
...
.method public removeObservers(Landroid/arch/lifecycle/̙̙;)V
    .locals 3
    .param p1    # Landroid/arch/lifecycle/̙̙;
        .annotation build Landroid/support/annotation/̗̙̗̙;
        .end annotation
    ...
    invoke-virtual {v0}, Landroid/arch/̗/̙/̖;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v2, p1}, Landroid/arch/lifecycle/̗̙̗;->̖̖(Landroid/arch/lifecycle/̙̙;)Z
    ...
    check-cast v1, Landroid/arch/lifecycle/̖̖̗;

    invoke-virtual {p0, v1}, Landroid/arch/lifecycle/LiveData;->removeObserver(Landroid/arch/lifecycle/̖̖̗;)V
